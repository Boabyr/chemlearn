...
`,
  ...
  quiz: [
    ...
    { id: "q2", question: "Was sagt der Retentionsfaktor k' über die Elutionsreihenfolge aus?", options: ["Die mit dem größten k'", "Die mit dem kleinsten k' (geringste Affinität zur stationären Phase)", "Die schwerste", "Die mit dem kleinsten Rf-Wert"], correct: 1, explanation: "k' = (tR-tM)/tM. Kleines k': kurze Retentionszeit, eluiert zuerst. Großes k': lange Retentionszeit, eluiert zuletzt. k'=0: Totzeit (Totvolumen, nicht retardiert)." },
