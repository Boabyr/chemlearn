...
`,
  ...
  quiz: [
    ...
    { id: "q3", question: "Welche Reaktion wird zur Messung von NO in der Luft mittels Chemolumineszenz verwendet?", options: ["NO + H₂O₂ → NO₂ + H₂O, dann Lichtemission", "NO + O₃ → NO₂* + O₂, dann NO₂* → NO₂ + hν", "NO + Luminol → NO₂ + hν in alkalischer Lösung", "NO + O₂ → NO₃ + hν bei Raumtemperatur"], correct: 1, explanation: "Ozon oxidiert NO zu elektronisch angeregtem NO₂. Beim Zurückfallen in den Grundzustand gibt es ein Photon ab, das gezählt wird. NO₂ in der Probe wird vorher katalytisch zu NO reduziert und mitbestimmt — daraus ergibt sich die Summe NOₓ. Luminol reagiert mit H₂O₂, nicht mit NO." },
