...
`,
  ...
  quiz: [
    ...
    { id: "q3", question: "Was ist das Faraday'sche Gesetz in der Coulometrie?", options: ["Q = C·U (die Ladung eines Kondensators)", "m = M·Q/(n·F): Masse proportional zur Ladung", "i = dQ/dt (Strom als Ladungsänderung)", "E = Q/C (Spannung am Kondensator)"], correct: 1, explanation: "Die umgesetzte Stoffmenge folgt direkt aus der geflossenen Ladung Q = I·t, geteilt durch n·F. Weil die Faraday-Konstante eine Naturkonstante ist, braucht die Coulometrie keine Kalibriergerade — vorausgesetzt, die Stromausbeute beträgt 100 %, jedes Elektron setzt also den Analyten um." },
    { id: "q4", question: "Was macht die Stripping-Voltammetrie so empfindlich?", options: ["Sie arbeitet mit besonders intensiven Lichtquellen", "Der Analyt wird erst angereichert, dann abgelöst", "Sie misst bei besonders kleinen Potentialen", "Sie nutzt einen Drei-Elektroden-Aufbau"], correct: 1, explanation: "In der Anreicherungsphase wird der Analyt über Minuten auf der Elektrode abgeschieden. Erst danach wird er in einem schnellen Potentialdurchlauf wieder aufgelöst, und das gesammelte Material liefert auf einmal seinen Strom. Diese Vorkonzentrierung bringt die Nachweisgrenze in den ng/L-Bereich." },
    { id: "q5", question: "Welches Kriterium zeigt ein reversibles System im Cyclovoltammogramm?", options: ["Es ist nur ein einziger Peak sichtbar", "Peakverhältnis nahe 1 und Abstand 57/n mV", "Hin- und Rückpeak liegen bei gleichem Potential", "Es fehlt ein Rückpeak vollständig"], correct: 1, explanation: "Beim reversiblen System sind kathodischer und anodischer Peakstrom etwa gleich groß, und die beiden Peakpotentiale liegen 57/n mV auseinander. Fehlt der Rückpeak oder wächst der Abstand mit der Vorschubgeschwindigkeit, ist das System quasireversibel oder irreversibel." },
