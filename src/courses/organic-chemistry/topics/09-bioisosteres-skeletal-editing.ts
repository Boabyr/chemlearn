...
`,
  ...
  quiz: [
    ...
    { id: "q6", question: "Warum greift das Dihalogencarben beim Indol die C2=C3-Bindung an und nicht den Stickstoff?", options: ["Weil der Stickstoff sterisch abgeschirmt ist", "Weil das freie Elektronenpaar des Stickstoffs im aromatischen π-System gebunden ist, während die C2=C3-Bindung enaminartig elektronenreich ist", "Weil der Stickstoff bereits protoniert vorliegt", "Weil Carbene grundsätzlich nicht mit Stickstoff reagieren"], correct: 1, explanation: "Der Indol-Stickstoff steuert sein Elektronenpaar zum aromatischen Sextett bei und steht als Nucleophil nicht zur Verfügung — genau wie beim Pyrrol. Angeboten wird stattdessen die C2=C3-Bindung, die durch die Donorwirkung des Stickstoffs enaminartig elektronenreich ist. Das Carben addiert dort, der entstehende Cyclopropanring öffnet sich, und aus dem Fünfring wird ein Sechsring." },
  ],
  flashcards: [
