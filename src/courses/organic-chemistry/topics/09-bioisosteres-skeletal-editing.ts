...
`,
  ...
  quiz: [
    { id: "q1", question: "What is a bioisostere and why is tetrazole a classic bioisostere of carboxylic acid?", options: ["An identical compound with the same formula","A compound with identical water solubility","A prodrug that is hydrolysed to COOH in vivo","A group of similar size and pKa but better stability"], correct: 3, explanation: "A bioisostere mimics the property the target recognises — here acidity, shape and hydrogen bonding — while changing the properties the body acts on. Tetrazole has a pKa around 4 to 5 like a carboxylic acid, but resists glucuronidation and is somewhat more lipophilic. It is not a prodrug: nothing converts it back." },
    { id: "q2", question: "What is 'skeletal editing' in modern synthetic chemistry?", options: ["Direct modification of an existing ring skeleton","Classical multi-step construction of a scaffold","Manipulation of protecting groups","Functional group interconversion without ring change"], correct: 0, explanation: "Skeletal editing changes the framework itself — inserting, deleting or swapping a ring atom — rather than rebuilding the target from simple precursors. The Ciamician-Dennstedt rearrangement, which turns a pyrrole into a pyridine by carbene insertion, is the textbook case: one carbon enters the ring and the ring size changes." },
    { id: "q3", question: "Which reagent is decisive for the Ciamician-Dennstedt rearrangement (pyrrole → pyridine)?", options: ["mCPBA as the oxidising agent","Dibromocarbene from CHBr₃ and base","Sodium amide as a strong base","n-Butyllithium for deprotonation"], correct: 1, explanation: "The reactive species is a dihalocarbene, generated from chloroform or bromoform with strong base. It adds across a C=C bond of the pyrrole; the resulting cyclopropane-fused bicycle then opens and expands the five-membered ring to a six-membered one, giving a 3-halopyridine." },
    ...
    { id: "q6", question: "Why does the dihalocarbene attack the C2=C3 bond of indole rather than the nitrogen?", options: ["Because the nitrogen lone pair is tied up in the π system","Because the nitrogen is sterically shielded","Because the nitrogen is already protonated","Because carbenes do not react with nitrogen atoms under any conditions"], correct: 0, explanation: "The indole nitrogen contributes its lone pair to the aromatic sextet and is not available as a nucleophile — exactly as in pyrrole. What is on offer instead is the C2=C3 bond, made electron-rich by that same donation. The carbene adds there, the cyclopropane ring opens, and the five-membered ring becomes a six-membered one." },
  ],
  flashcards: [
