...
`,
  interactive: {
    type: "mechanism",
    title: "Kröhnke pyridine synthesis — the first step",
    description: "Everything starts by turning pyridine itself into a reagent.",
    stages: [
      {
        id: 0, label: "Pyridine alkylates the bromoketone", description: "Draw the arrow from the pyridine nitrogen to the carbon bearing the bromine.",
        hint1: "Pyridine acts as the nucleophile here, not as a base — its lone pair sits in the ring plane and is fully available.", hint2: "The product is a pyridinium salt. Its α-CH is acidic, so deprotonation gives the ylide that performs the Michael addition in the next step.",
        atoms: [
          { id: "Npy", label: "N", x: 110, y: 130, color: "#60a5fa", r: 20 },
          { id: "Cpy", label: "py", x: 60, y: 80, color: "#94a3b8", r: 16 },
          { id: "Ca", label: "CH₂", x: 250, y: 130, color: "#e2e8f0", r: 20 },
          { id: "Br", label: "Br", x: 250, y: 205, color: "#4ade80", r: 18 },
          { id: "Ck", label: "C=O", x: 325, y: 90, color: "#e2e8f0", r: 20 },
          { id: "Ok", label: "O", x: 385, y: 45, color: "#f87171", r: 16 },
        ],
        bonds: [
          { a: "Npy", b: "Cpy", dash: false, color: "#64748b" },
          { a: "Ca", b: "Br", dash: false, color: "#64748b" },
          { a: "Ca", b: "Ck", dash: false, color: "#64748b" },
          { a: "Ck", b: "Ok", dash: false, color: "#64748b" },
        ],
        correctArrow: { from: "Npy", to: "Ca" },
      },
    ],
  },
  quiz: [
