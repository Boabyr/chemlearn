...
`,
  ...
  quiz: [
    { id: "q1", question: "What is the first step in the Paal-Knorr mechanism for pyrrole synthesis?", options: ["Oxidation of the 1,4-dicarbonyl compound","A Diels-Alder reaction of the diketone","Radical initiation by heat or light","Attack of the amine on a protonated carbonyl"], correct: 3, explanation: "Acid protonates one carbonyl and makes it more electrophilic; the amine adds to give a hemiaminal. Dehydration then produces the imine, the second carbonyl is attacked by the same nitrogen, water leaves again, and tautomerisation delivers the aromatic pyrrole. Aromatisation is what pays for the whole sequence." },
    { id: "q2", question: "What is the driving force of the Kondrat'eva pyridine synthesis?", options: ["Aromatisation plus escape of CO₂ as a gas","Catalysis by a strong acid","Reduction of the azadiene component","Nothing — the reaction is endothermic"], correct: 0, explanation: "The bridged bicycle formed in the first step is strained and not aromatic. Fragmenting it expels CO₂, which leaves the solution, and produces an aromatic pyridine. Gas evolution and aromatisation together make the step effectively irreversible — no catalyst required, only heat." },
    ...
    { id: "q4", question: "In the Kröhnke mechanism: what is the role of pyridine in the first step?", options: ["It serves purely as a catalyst","It is used only as the solvent for the alkylation step","It is the nucleophile alkylating the bromoketone","It acts as the oxidant in the sequence"], correct: 2, explanation: "Pyridine attacks the carbon bearing the bromine and becomes a pyridinium salt. That salt has an acidic α-CH, and deprotonation gives the ylide that performs the Michael addition. Pyridine returns as the leaving group at the end — used twice, consumed not at all." },
    { id: "q5", question: "What makes the [4+2] + retro-[4+2] sequence so useful for heterocycle synthesis?", options: ["The sequence needs no reagents at all","It works exclusively at room temperature and normal pressure","It always produces five-membered rings","A small stable molecule leaves and a ring aromatises"], correct: 3, explanation: "The cycloaddition builds a bridged bicycle, and the retro-step fragments it, expelling CO₂, N₂ or SO₂. Because a gas escapes the solution and the remaining ring becomes aromatic, the second step cannot run backwards. That combination is what makes the pattern so reliable." },
    { id: "q6", question: "Triazine and tetrazine both lose N₂ in the retro-[4+2]. Why do they give different rings?", options: ["Because a triazine brings three nitrogens, a tetrazine four","Because tetrazine reacts at higher temperature","Because triazine expels HCN rather than N₂","Because the dienophile oxygen enters the tetrazine ring"], correct: 0, explanation: "Counting nitrogens is the quickest check. A 1,2,4-triazine brings three; two leave as N₂ and one stays in the ring, giving pyridine. A 1,2,4,5-tetrazine brings four; two leave and two stay, giving pyridazine. The mechanism is identical in both cases — only the starting material counts differently." },
  ],
  flashcards: [
