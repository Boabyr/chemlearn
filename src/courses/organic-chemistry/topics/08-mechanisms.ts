...
`,
  ...
  quiz: [
    ...
    { id: "q6", question: "Triazin und Tetrazin verlieren beide N₂ in der Retro-[4+2]. Warum entstehen trotzdem verschiedene Ringe?", options: ["Weil Tetrazin bei höherer Temperatur reagiert", "Weil ein 1,2,4-Triazin drei Stickstoffe mitbringt und einer im Ring bleibt (Pyridin), ein 1,2,4,5-Tetrazin dagegen vier und zwei bleiben (Pyridazin)", "Weil Triazin kein N₂ abgibt, sondern HCN", "Weil beim Tetrazin der Sauerstoff des Dienophils in den Ring geht"], correct: 1, explanation: "Die Stickstoffbilanz ist die schnellste Probe: Vom Triazin gehen zwei der drei Stickstoffe als N₂ weg, einer bleibt — Pyridin. Vom Tetrazin gehen zwei der vier weg, zwei bleiben — Pyridazin. Der Mechanismus ist in beiden Fällen derselbe, nur das Ausgangsmaterial zählt anders." },
  ],
  flashcards: [
