...
`,
  ...
  quiz: [
    ...
    { id: "q3", question: "What is special about the Boger reaction for pyridine synthesis?", options: ["A triazine reacts as azadiene with an enamine; N₂ is eliminated retro-[4+2]", "Two alkyne molecules and a nitrile trimerise under cobalt catalysis to a pyridine", "A pyrrole rearranges via cyclopropane to a pyridine", "A 1,5-dicarbonyl reacts with NH₃"], correct: 0, explanation: "In the Boger reaction a triazine acts as aza-diene and reacts with an electron-rich dienophile (e.g. enamine) in a [4+2] cycloaddition. The bicyclic intermediate collapses immediately with loss of N₂ (retro-DA, XY = N₂) to give the substituted pyridine." },
    { id: "q4", question: "What is the Chichibabin reaction?", options: ["Bromination of pyridine at C-3", "Nucleophilic amination of pyridine with NaNH₂ → 2-aminopyridine", "Oxidation of pyridine to the N-oxide", "Cycloaddition of pyridine with electron-poor dienophiles under heat"], correct: 1, explanation: "The Chichibabin reaction is a nucleophilic aromatic substitution: pyridine + NaNH₂ → 2-aminopyridine + NaH. The amide anion attacks C-2 nucleophilically (ortho to N, activated). The Meisenheimer complex is the intermediate." },
    ...
    { id: "q6", question: "Why are the 2- and 4-positions of pyridine preferred for SNAr?", options: ["π electron density is highest at those positions", "Nitrogen stabilises the anionic Meisenheimer complex from there", "Reactions under thermodynamic control always occur at those positions", "The N atom acts as a σ-donor at those positions"], correct: 1, explanation: "In SNAr at C-2 or C-4 of pyridine the negative charge of the Meisenheimer complex can be directly delocalised onto the electron-deficient N atom → stabilisation → lower activation energy. At C-3 this delocalisation is not possible." },
    { id: "q7", question: "Why does a pyridine N-oxide activate the ring for both SEAr and SNAr?", options: ["Because the oxide forces the ring into a strictly planar geometry", "Because the oxide can both donate and withdraw density", "Because it removes nitrogen from the ring", "Because it destroys the aromatic system"], correct: 1, explanation: "The N-oxide is a resonance hybrid. In one structure the negatively charged oxygen pushes density into the ring, which activates position 4 towards electrophiles. In another the positively charged nitrogen pulls density out, which activates the ring towards nucleophiles. That is why the N-oxide is the standard detour when pyridine itself is too unreactive." },
  ],
  flashcards: [
