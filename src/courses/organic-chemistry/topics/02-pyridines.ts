...
`,
  ...
  quiz: [
    ...
    { id: "q2", question: "In der Kröhnke-Synthese übernimmt Pyridin zwei Rollen. Welche?", options: ["Es ist Lösungsmittel und Base", "Es alkyliert zunächst das α-Bromketon als Nucleophil und tritt am Ende als Abgangsgruppe wieder aus", "Es ist Oxidationsmittel und Katalysator", "Es liefert den Ringstickstoff des Produkts"], correct: 1, explanation: "Pyridin greift zuerst das α-Bromketon an und wird zum Pyridiniumsalz, dessen α-CH acide ist — daraus entsteht das Ylid. Nach Michael-Addition und Ringschluss verlässt Pyridin das Molekül wieder. Der Ringstickstoff des Produkts stammt aus dem Ammoniumacetat, nicht aus dem Pyridin. Weil nur eine Kombination der drei Bausteine möglich ist, ist die Reaktion regiochemisch sauber." },
    ...
    { id: "q7", question: "Warum aktiviert ein Pyridin-N-oxid den Ring sowohl für SEAr als auch für SNAr?", options: ["Weil es den Ring planar macht", "Weil das Oxid Elektronendichte in den Ring schieben und ebenso abziehen kann, je nach Angriffsort", "Weil es den Stickstoff aus dem Ring entfernt", "Weil es die Aromatizität aufhebt"], correct: 1, explanation: "Das N-Oxid ist ein Mesomerie-Zwitter: Über eine Grenzstruktur schiebt der negativ geladene Sauerstoff Elektronendichte in den Ring (das aktiviert Position 4 für Elektrophile), über eine andere zieht der positiv geladene Stickstoff sie ab (das aktiviert für Nucleophile). Deshalb ist das N-Oxid der übliche Umweg, wenn Pyridin selbst zu reaktionsträge ist." },
  ],
  flashcards: [
