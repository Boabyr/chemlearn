...
`,
  ...
  quiz: [
    { id: "q1", question: "Why does imidazole have a pKa of 7.0 despite containing two N atoms?", options: ["Both nitrogen atoms are equally basic and share the proton","An oxygen atom raises the basicity","One nitrogen is pyrrole-like, the other pyridine-like","The ring carries eight π electrons"], correct: 2, explanation: "N-1 carries the hydrogen and donates its lone pair to the aromatic sextet — it is not basic. N-3 keeps its lone pair in the ring plane and is freely available, so that is where protonation happens. The resulting pKa of about 7 puts imidazole right at physiological pH, which is why histidine works as an acid-base catalyst in enzymes." },
    { id: "q2", question: "Why can an isoxazole be regarded as a masked β-enaminone?", options: ["Because acid tautomerises it to the enol","Because it loses CO₂ on heating","Because the ring is not aromatic and opens spontaneously","Because the weak N–O bond can be cleaved to release it"], correct: 3, explanation: "The N–O bond is the weakest bond in the ring and can be cleaved reductively or under base, which unmasks a β-enaminone. The ring therefore acts as a protecting group: build it, run reactions the open enaminone would not survive, then open it again at the end." },
    { id: "q3", question: "What is special about CuAAC click chemistry for triazole synthesis?", options: ["It gives only the 1,4-disubstituted triazole","It always gives the 1,5-disubstituted ring","It needs high pressure and high temperature","It proceeds through a carbene intermediate"], correct: 0, explanation: "The uncatalysed thermal Huisgen reaction gives a mixture of the 1,4 and 1,5 isomers. Copper(I) binds the terminal alkyne as an acetylide and steers the cycloaddition to a single regioisomer, the 1,4-product — at room temperature, in water, and tolerant of almost every functional group. That combination is what made it click chemistry." },
    { id: "q4", question: "In which drug does the thiazolium ion play a central role as a coenzyme?", options: ["Imidazole in histidine residues", "Thiamine, that is vitamin B1", "Caffeine as a purine alkaloid", "Histidine as a free amino acid"], correct: 1, explanation: "Thiamine pyrophosphate carries a thiazolium ring whose C-2 proton is unusually acidic. Deprotonation gives a carbene-like ylide that attacks carbonyl groups — the key step in pyruvate decarboxylase and transketolase. The sulfur is what makes the C-2 position acidic enough." },
    { id: "q5", question: "Which nomenclature is important for 3-amino-1H-1,2,4-triazole?", options: ["It describes a six-membered ring","The name indicates oxygen in the ring","1H marks the N–H, 3-amino the NH₂ at C-3","Numbering would start at a sulfur atom"], correct: 2, explanation: "1,2,4-Triazole has three nitrogens at positions 1, 2 and 4. The indicated hydrogen 1H says which nitrogen carries the proton — without it the name would be ambiguous, because the tautomer with the H at N-4 is a different compound. 3-Amino places the NH₂ group at carbon 3." },
    { id: "q6", question: "Unsubstituted imidazole shows tautomerism. What does that mean for its two nitrogens?", options: ["The ring opens and closes continuously","One nitrogen leaves the ring entirely","The rapid tautomerism destroys the aromatic sextet of the ring","They swap roles so fast that C-4 and C-5 become equivalent"], correct: 3, explanation: "The N–H proton migrates rapidly between the two nitrogens. The pyrrole-type nitrogen becomes the pyridine-type one and back, so positions 4 and 5 can no longer be told apart in unsubstituted imidazole. Put a substituent on one nitrogen and the tautomerism is blocked — the positions become distinct again." },
  ],
  flashcards: [
