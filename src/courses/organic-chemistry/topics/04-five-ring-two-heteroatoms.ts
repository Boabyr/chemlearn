...
`,
  ...
  quiz: [
    ...
    { id: "q5", question: "Which nomenclature is important for 3-amino-1H-1,2,4-triazole?", options: ["It describes a six-membered ring", "1H marks the N–H, 3-amino the NH₂ at C-3", "The name indicates oxygen in the ring", "Numbering would start at a sulfur atom"], correct: 1, explanation: "1,2,4-Triazole has three nitrogens at positions 1, 2 and 4. The indicated hydrogen 1H says which nitrogen carries the proton — without it the name would be ambiguous, because the tautomer with the H at N-4 is a different compound. 3-Amino places the NH₂ group at carbon 3." },
    { id: "q6", question: "Unsubstituted imidazole shows tautomerism. What does that mean for its two nitrogens?", options: ["They swap roles so fast that C-4 and C-5 become equivalent", "The ring opens and closes continuously", "One nitrogen leaves the ring entirely", "The rapid tautomerism destroys the aromatic sextet of the ring"], correct: 0, explanation: "The N–H proton migrates rapidly between the two nitrogens. The pyrrole-type nitrogen becomes the pyridine-type one and back, so positions 4 and 5 can no longer be told apart in unsubstituted imidazole. Put a substituent on one nitrogen and the tautomerism is blocked — the positions become distinct again." },
  ],
  flashcards: [
