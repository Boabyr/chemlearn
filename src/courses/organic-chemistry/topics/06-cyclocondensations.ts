...
`,
  ...
  quiz: [
    ...
    { id: "q5", question: "Which reagent combination gives an isoxazole?", options: ["A 1,4-dicarbonyl with ammonia","An organic azide with an alkyne","A β-enol ketone with hydroxylamine","An aldehyde with malononitrile"], correct: 2, explanation: "Hydroxylamine brings both heteroatoms of the isoxazole ring: the nitrogen and the oxygen, already bonded to each other. The 1,3-dicarbonyl supplies the three carbons. Replace hydroxylamine with hydrazine and the same skeleton gives a pyrazole instead." },
    { id: "q6", question: "What is the van Leusen synthesis and what does it produce?", options: ["Pyridine from a triazine precursor","Furan from a 1,4-dicarbonyl compound","Oxazole from an isocyanide and a ketone","Imidazole from TosMIC and an aldimine"], correct: 3, explanation: "TosMIC supplies C-2 and one nitrogen; the aldimine supplies the rest of the ring. The tosyl group leaves as sulfinate at the end, which drives the aromatisation. Do not confuse it with Debus-Radziszewski, which builds imidazoles from a 1,2-dicarbonyl, an aldehyde and two equivalents of ammonia." },
  ],
  flashcards: [
