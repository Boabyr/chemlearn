...
`,
  ...
  quiz: [
    ...
    { id: "q2", question: "Which regioisomer forms preferentially in the [3+2] CA of an unsymmetrical nitrile oxide with a terminally substituted alkene?", options: ["4-substituted isoxazoline","3-substituted isoxazoline (nitrile oxide-C at C-3)","5-substituted isoxazoline (nitrile oxide-C at C-5)","Both isomers in equal parts"], correct: 2, explanation: "FMO control: HOMO of nitrile oxide and LUMO of alkene. The largest HOMO coefficient is at the nitrile oxide C (terminal), the largest LUMO coefficient at the β-C of the alkene → 5-substituted isoxazoline preferred." },
    { id: "q3", question: "What happens in the Diels-Alder reaction of oxazole with an alkyne (Kondrat'eva)?", options: ["Direct addition without any intermediate","Nucleophilic aromatic substitution at the oxazole","Ring opening of the oxazole, then recyclisation","Cycloaddition, then retro-[4+2] with loss of CO₂"], correct: 3, explanation: "The oxazole acts as the 4π azadiene and the alkyne as the 2π dienophile. The bridged bicycle that forms is never isolated: it fragments thermally, expelling CO₂ and leaving an aromatic pyridine. Gas evolution plus aromatisation make that second step irreversible." },
    { id: "q4", question: "A furan ring in a product points retrosynthetically to which reaction?", options: ["A Paal-Knorr synthesis from a 1,4-dicarbonyl","A [4+2] cycloaddition with an azadiene","A [3+2] with a nitrile oxide or azide","A nucleophilic aromatic substitution"], correct: 0, explanation: "A furan carries one oxygen and no nitrogen, which rules out the nitrogen-delivering dipoles. Substituents at C-2 and C-5 are the signature of a 1,4-dicarbonyl closed under acid. As a rule: count the heteroatoms first, then ask which building block could have brought them in." },
