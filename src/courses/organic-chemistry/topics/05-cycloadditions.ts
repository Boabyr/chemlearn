...
`,
  ...
  quiz: [
    ...
    { id: "q6", question: "Ein Nitriloxid reagiert einmal mit einem Alkin und einmal mit einem Alken. Was unterscheidet die Produkte?", options: ["Das Alkin gibt das aromatische Isoxazol, das Alken das um eine Bindung gesättigtere Isoxazolin", "Beide geben dasselbe Produkt", "Das Alken gibt ein sechsgliedriges Ringsystem", "Nur das Alken reagiert, Alkine sind zu unreaktiv"], correct: 0, explanation: "Der Dipol legt fest, welche Heteroatome in den Ring kommen; das Dipolarophil legt fest, wie gesättigt er wird. Alkin heißt vollständig ungesättigt und damit aromatisch, Alken heißt eine Bindung mehr gesättigt. Dieselbe Regel gilt für alle 1,3-Dipole: Azid plus Alkin gibt Triazol, Azid plus Alken gibt Triazolin." },
  ],
  flashcards: [
