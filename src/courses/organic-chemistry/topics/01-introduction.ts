...
`,
  ...
  quiz: [
    { id: "q1", question: "Which statement about the aromaticity of pyrrole is correct?", options: ["The lone pair of N is not part of the π system","Pyrrole is not aromatic, because a heteroatom interrupts the conjugation","Pyrrole follows the 4n rule and is antiaromatic","Pyrrole has 6 π electrons and is therefore aromatic (Hückel: n=1)"], correct: 3, explanation: "Pyrrole has 6 π electrons (4 from the two double bonds + 2 from the N lone pair). The sp²-N lone pair lies in the ring plane and is part of the π system → pyrrole is aromatic (Hückel, n=1)." },
    { id: "q2", question: "Why is pyridine (pKa 5.2) significantly more basic than pyrrole (pKa ~0)?", options: ["In pyrrole the lone pair sits in the π system","Pyridine simply contains more carbon atoms","Pyridine forms a six- and pyrrole a five-ring","The nitrogen of pyridine is sp³-hybridised"], correct: 0, explanation: "Pyrrole needs its nitrogen lone pair to reach the aromatic sextet. Protonating it would destroy the aromaticity, which is far too costly. In pyridine the lone pair sits in an sp² orbital in the ring plane, outside the π system, and is freely available — hence pKa 5.2 for the conjugate acid." },
    { id: "q3", question: "Which of the following heterocycles is least basic?", options: ["Piperidine","Pyrrole","Pyridine","Imidazole"], correct: 1, explanation: "Pyrrole has its N lone pair fully incorporated into the π system (required for aromaticity). Piperidine (sp³-N, pKa~11) > Imidazole (pKa 7.0) > Pyridine (pKa 5.2) > Pyrrole (pKa ~0)." },
    { id: "q4", question: "What is the Hantzsch-Widman system?", options: ["A nomenclature system for naming acyclic compounds that contain heteroatoms","A method for the synthesis of pyridines","A systematic nomenclature system for 3- to 10-membered heterocycles","A system for determining aromaticity"], correct: 2, explanation: "The Hantzsch-Widman system is an IUPAC nomenclature system specifically for small to medium-sized heterocycles (3–10-membered). It combines prefixes for heteroatoms (oxa-, thia-, aza-) with suffixes for ring size and degree of unsaturation (e.g. -ole, -ine)." },
    { id: "q5", question: "What trivial name does 1-azabenzene carry?", options: ["Imidazole","Pyrimidine","Pyrrole","Pyridine"], correct: 3, explanation: "1-Azabenzene = pyridine. The systematic name describes the benzene ring with one CH replaced by N. Pyrimidine would be 1,3-diazabenzene." },
