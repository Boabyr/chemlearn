...
`,
  ...
  quiz: [
    { id: "q1", question: "Why is C-2 (α position) preferred over C-3 in SEAr of furan?", options: ["C-2 is the sterically easier position","C-2 carries more density in the HOMO","C-2 attack gives three resonance structures","The oxygen sits right next to C-2"], correct: 2, explanation: "Attack at C-2 delocalises the positive charge over three structures, one of which places it on oxygen with a full octet everywhere. Attack at C-3 offers only two. Proximity to the heteroatom is not the argument by itself — indole sits next to nitrogen at C-2 and still reacts at C-3." },
    { id: "q2", question: "Indole reacts with Br⁺ at which position?", options: ["C-1 (N)","C-2","C-7","C-3"], correct: 3, explanation: "C-3 is preferred for SEAr at indole. Rationale: attack at C-3 preserves benzene aromaticity; positive charge delocalised onto N without interrupting the benzene ring → most stable arenium ion." },
    { id: "q3", question: "Why does the stability of the arenium ion decide regioselectivity, rather than the charge distribution in the starting material?", options: ["Because the electrophilic attack is rate-determining","Because the arenium ion is the final product","Because the deprotonation is the slowest step","Because the electrophile picks its position first"], correct: 0, explanation: "Every position gets attacked. Only the one with the lowest transition state proceeds fast enough to matter — and that transition state resembles the arenium ion that follows. Regioselectivity therefore reduces to drawing the possible cations and comparing how well each spreads the charge." },
    ...
    { id: "q5", question: "Why is SEAr at pyridine so much slower than at benzene?", options: ["Pyridine is the smaller aromatic ring","Pyridine has no free electrons at all","Nitrogen withdraws density and lowers the HOMO","Electrophilic substitution there is forbidden"], correct: 2, explanation: "The electronegative nitrogen pulls π density out of the ring, so the HOMO sits lower and interacts less well with an electrophile. Pyridine therefore reacts roughly a million times slower than benzene and needs forcing conditions. The same property makes it an excellent substrate for nucleophiles." },
    { id: "q6", question: "Why does electrophilic substitution on pyridine proceed at C-3 rather than C-2 or C-4?", options: ["Because C-3 is the least hindered position","Because C-3 carries the highest partial charge","Because pyridine reacts through its N-oxide","Because C-2 or C-4 would put the charge on nitrogen"], correct: 3, explanation: "In the arenium ion from C-2 or C-4 attack, one resonance structure places the positive charge on the nitrogen — the most electronegative atom in the ring, and one that is already withdrawing density. Attack at C-3 avoids that structure entirely. The reaction stays slow either way, because the ring is electron-poor to begin with." },
  ],
  flashcards: [
