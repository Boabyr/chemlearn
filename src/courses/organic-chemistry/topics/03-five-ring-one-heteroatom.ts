...
`,
  ...
  quiz: [
    ...
    { id: "q2", question: "Which compound is formed in the Paal-Knorr synthesis from a 1,4-dicarbonyl with a primary amine?", options: ["Furan","Thiophene","Pyrrole","Pyridine"], correct: 2, explanation: "The Paal-Knorr synthesis gives N-substituted pyrroles from 1,4-dicarbonyl compounds + primary amine (R-NH₂). With NH₃ → NH-pyrrole, with H₂O/H⁺ → furan, with H₂S/H⁺ or P₄S₁₀ → thiophene." },
    { id: "q3", question: "What property fundamentally distinguishes pyrrole from pyridine regarding the N-H bond?", options: ["Pyrrole has no N–H bond at all","The pyrrole N–H is strongly basic","The pyrrole N–H cannot be deprotonated","The pyrrole N–H is acidic, pKa 17.5"], correct: 3, explanation: "Pyridine has no N–H and is a base through its free lone pair. Pyrrole has an N–H and is a weak acid: deprotonation gives the pyrrolide anion, which is aromatic and therefore stabilised. Strong bases such as NaH or n-BuLi do the job, and the anion is the entry point to N-substituted pyrroles." },
    ...
    { id: "q5", question: "Which heteroaromatic is most strongly activated for SEAr (most reactive)?", options: ["Benzene","Pyrrole","Thiophene","Furan"], correct: 1, explanation: "Pyrrole is most reactive for SEAr. The N atom is less electronegative than O or S, so the lone pair in pyrrole-N is more strongly donated into the ring → highest π electron density → highest HOMO." },
    { id: "q6", question: "A 1,4-dicarbonyl compound is treated with P₄S₁₀. Which ring is formed?", options: ["Pyrrole", "Furan", "Thiophene", "Imidazole"], correct: 2, explanation: "The Paal-Knorr synthesis is one reaction with three reagents: ammonia or a primary amine gives pyrrole, acid alone gives furan, and P₄S₁₀ or H₂S/H⁺ gives thiophene. The reagent decides the heteroatom; the carbon skeleton comes from the 1,4-dicarbonyl in every case." },
  ],
  flashcards: [
