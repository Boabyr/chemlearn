...
`,
  ...
  quiz: [
    ...
    { id: "q3", question: "What property fundamentally distinguishes pyrrole from pyridine regarding the N-H bond?", options: ["Pyrrole has no N–H bond at all", "The pyrrole N–H is acidic, pKa 17.5", "The pyrrole N–H is strongly basic", "The pyrrole N–H cannot be deprotonated"], correct: 1, explanation: "Pyridine has no N–H and is a base through its free lone pair. Pyrrole has an N–H and is a weak acid: deprotonation gives the pyrrolide anion, which is aromatic and therefore stabilised. Strong bases such as NaH or n-BuLi do the job, and the anion is the entry point to N-substituted pyrroles." },
