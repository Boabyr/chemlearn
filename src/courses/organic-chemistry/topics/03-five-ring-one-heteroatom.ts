...
`,
  ...
  quiz: [
    ...
    { id: "q6", question: "Ein 1,4-Dicarbonyl wird mit P₄S₁₀ umgesetzt. Welcher Ring entsteht?", options: ["Pyrrol", "Furan", "Thiophen", "Imidazol"], correct: 2, explanation: "Die Paal-Knorr-Synthese ist dieselbe Reaktion mit drei Reagenzien: NH₃ oder ein primäres Amin gibt Pyrrol, Säure allein gibt Furan, P₄S₁₀ oder H₂S/H⁺ gibt Thiophen. Das Reagenz entscheidet allein über das Heteroatom — das Kohlenstoffgerüst bringt in allen drei Fällen das 1,4-Dicarbonyl mit." },
  ],
  flashcards: [
